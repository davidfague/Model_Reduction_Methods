class SpikeGenerator():
  ...
  def generate_inputs(synapses, t, mean_firing_rate, method=str, 
                      same_presynaptic_cell: bool = False, same_presynaptic_region: bool = False, 
                      rhythmicity: bool = False, rhythmic_mod = None, rhythmic_f = None,
                      spike_trains_to_delay=None. time_shift=None):
    '''
    method for generating spike trains
    ---------------------------------------------
  ...
  def firing_rate_profile(t, mean_firing_rate, method=str, 
